...
while read line; 
do
    # finding the time of the op value
    ...
    # extract the configuration from the initial path provided
    
    gmx trjconv -f /ocean/projects/see220002p/minhx010/LiF-RETIS/init-path.trr -o config_extraction/gl-initf_ens-${interface_num}.trr -dump "$exttime" <<< "0" 
